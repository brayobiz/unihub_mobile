...
import 'data/repositories/user_activity_repository_impl.dart';
...
export 'domain/repositories/user_activity_repository.dart';
...
final userActivityRepositoryProvider = Provider<UserActivityRepository>((ref) {
  return UserActivityRepositoryImpl(ref.watch(firestoreProvider));
});

final notificationsProvider = StreamProvider.autoDispose.family<List<UniNotification>, String?>((ref, module) {
...
final unreadNotificationsCountProvider = StreamProvider.autoDispose.family<int, String?>((ref, module) {
  final user = ref.watch(authStateProvider).valueOrNull;
