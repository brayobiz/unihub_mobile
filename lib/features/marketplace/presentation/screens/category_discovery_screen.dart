...
class CategoryDiscoveryScreen extends ConsumerWidget {
  ...
  Widget _buildAllListingsGrid(WidgetRef ref) {
    final listingsAsync = ref.watch(listingsProvider(ListingFilter(selectedCategory: category)));
